...
export class QuotePdfService {
  ...
  quotesPdf: QuotePdf[] = []
  quotePdfChange: BehaviorSubject<QuotePdf[]> = new BehaviorSubject(this.quotesPdf);
  ...
  eventQuotePdf(quotePdf: any)
  {
    this.quotePdfChange.next(quotePdf);
  }
  ...
  {
    return this.http.get<QuotePdf[]>("https://localhost:9001/quotepdf");
  }
