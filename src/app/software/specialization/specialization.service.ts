...
export class SpecializationService {
  ...
  specializationChange: BehaviorSubject<Specialization[]> = new BehaviorSubject(this.specialization);
  ...
  */  
  ...
  eventSpecialization(specialization: any)
  {
    this.specializationChange.next(specialization);
  }
